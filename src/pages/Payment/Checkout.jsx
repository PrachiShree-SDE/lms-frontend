    ...
    async function handleSubscription(e) {
        ...
        const options = {
            ...
            handler: async function (response) {
                ...
                paymentDetails.razorpay_subscription_id = response.razorpay_payment_id;
                ...
                <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg  relative">
                    ...
                    <div className="px-4 space-y-5 text-center">
                        <p className="text-[17px] ">
                            This purchases will allow you  to access all the  available courses on our  plateform for {" "}
                            <span className="font-bold text-yellow-500">1 yr duration</span>{" "}
                            All the existing and new lounched courses will be available
                        </p>
