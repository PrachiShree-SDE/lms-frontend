...
function handleImage(e) {
 ...
 if(!isValidPassword(signupDetails.password)) {
     toast.error("Invalid password provided, password shuld 6-16 character long with at least a number and a special character ");
    return;
}
                    ...
                    <input
                     ...
                     <div className="flex flex-col gap-1">
                        ...
                        <input 
                            ...
                            type="password" 
                            name="password"
                            className="bg-transparen t px-2  py-1 border"
