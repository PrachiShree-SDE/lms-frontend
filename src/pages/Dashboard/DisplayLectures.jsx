                    ...
                    <div className="flex justify-center gap-10 w-full">
                        ...
                        <div className="space-y-5 w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black]">
                            ...
                            <h1>
                                ...
                                {lecture[currentVideo]?.title}
                            </h1>
                            <p>
                                <span className="text-yellow-500">
                                    Description: {''}
                                </span> 
                                {lecture[currentVideo]?.description}
                            </p>
                        </div>
                        ...
                        <ul className="w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black] space-y-5">
                                <li className="font-semibold text-xl text-yellow-500 flex items-center justify-between"> 
                                    ...
                                    {
                                       role === "ADMIN" && (
                                            <button onClick={() => navigate("/course/addlecture") } className="btn btn-primary px-2 py-1 rounded-md font-semibold text-sm">
                                                Add new lecture
                                            </button>
                                       )}
                                </li>
